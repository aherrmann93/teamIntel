...
/**
 * Checks that the game ends when the top border is hit.
 *
...
public class TopBorderCollisionUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        // Wait 5 seconds to give the plane enough time to rise to hit the border
        Thread.sleep(5000);
    }

    @Test
    public void checkBorderTopCollision() {
